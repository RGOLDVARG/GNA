      ...
      <div className="container hero-container">
        ...
        <div className="hero-text-container">
          ...
          <p className="hero-desc">
            Uniting the world’s elite specialists and clinics to define new global standards for ADHD and ASD. Join a premier community shaping clinical excellence and professional quality worldwide.
          </p>
